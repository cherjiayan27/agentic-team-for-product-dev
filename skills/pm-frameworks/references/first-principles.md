...
- [Core Identity](#core-identity) — Reasoning style and communication rules
- [Analysis Framework](#analysis-framework) — 4-phase deconstruction process
  - [Phase 1: Surface the Assumptions](#phase-1-surface-the-assumptions)
  - [Phase 2: Establish First Principles](#phase-2-establish-first-principles)
  - [Phase 3: Rebuild from the Foundation](#phase-3-rebuild-from-the-foundation)
  - [Phase 4: The High-Leverage Move](#phase-4-the-high-leverage-move)
- [When to Apply the 5-Step Process](#when-to-apply-the-5-step-process)

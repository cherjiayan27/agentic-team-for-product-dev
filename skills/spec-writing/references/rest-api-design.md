...
- [Core Principles](#core-principles) — Resources vs actions, hierarchical structure
- [Resource Naming Conventions](#resource-naming-conventions) — Kebab-case, pluralization
- [HTTP Methods Usage](#http-methods-usage) — GET, POST, PUT, PATCH, DELETE semantics
- [Status Codes](#status-codes) — 2xx, 3xx, 4xx, 5xx reference
- [URL Design Patterns](#url-design-patterns) — Filtering, pagination, sorting, search
- [Response Format Standards](#response-format-standards) — Single, collection, error shapes
- [Field Naming Conventions](#field-naming-conventions) — camelCase, booleans, dates
- [Content Negotiation](#content-negotiation) — Accept/Content-Type headers
- [Caching Guidelines](#caching-guidelines) — Cache-Control, ETags
- [Security Headers](#security-headers) — Auth, CORS
- [Rate Limiting](#rate-limiting) — Headers and response format
- [Hypermedia (HATEOAS)](#hypermedia-hateoas) — Links in responses

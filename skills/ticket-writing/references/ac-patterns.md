...
- [Pattern Structure](#pattern-structure) — GWT format, rules
- [Authentication Patterns](#authentication-patterns) — Login, token refresh, logout
- [CRUD Patterns](#crud-patterns) — Create, read, update, delete, list, pagination
- [Search Patterns](#search-patterns) — Basic search, empty results, special characters
- [File Upload Patterns](#file-upload-patterns) — Happy path, size exceeded, invalid type
- [Payment Patterns](#payment-patterns) — Charge, declined, idempotency
- [Notification Patterns](#notification-patterns) — Email, delivery failure + retry
- [Negative Test Patterns](#negative-test-patterns) — Unauthorized, rate limiting, concurrent modification
- [Performance Criteria Patterns](#performance-criteria-patterns) — Response time, throughput, memory
- [Accessibility Criteria Patterns](#accessibility-criteria-patterns) — Keyboard, screen reader, contrast, reduced motion
- [Writing Tips](#writing-tips) — Do / Do Not / Smell Tests
